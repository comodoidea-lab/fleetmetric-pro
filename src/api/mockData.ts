...
export const MOCK_VEHICLES: Vehicle[] = [
  { '車両ID': 'V001', '車両名': 'トヨタ プリウス', 'ナンバー': '品川 300 あ 1234', 'メーカー': 'トヨタ', '車種': 'プリウス', '年式': '2021', '車検期限': fmt(addDays(today, 45)), '法定点検期限': fmt(addDays(today, 120)), 'ステータス': '稼働中', '備考': '', '登録日': '2021/04/01' },
  { '車両ID': 'V002', '車両名': 'ホンダ フィット', 'ナンバー': '新宿 500 い 5678', 'メーカー': 'ホンダ', '車種': 'フィット', '年式': '2020', '車検期限': fmt(addDays(today, 20)), '法定点検期限': fmt(addDays(today, 200)), 'ステータス': '稼働中', '備考': '', '登録日': '2020/06/15' },
  { '車両ID': 'V003', '車両名': '日産 ノート', 'ナンバー': '渋谷 100 う 9012', 'メーカー': '日産', '車種': 'ノート', '年式': '2019', '車検期限': fmt(subDays(today, 5)), '法定点検期限': fmt(addDays(today, 60)), 'ステータス': '整備中', '備考': 'オイル交換待ち', '登録日': '2019/09/01' },
  { '車両ID': 'V004', '車両名': 'スズキ スイフト', 'ナンバー': '世田谷 400 え 3456', 'メーカー': 'スズキ', '車種': 'スイフト', '年式': '2022', '車検期限': fmt(addDays(today, 300)), '法定点検期限': fmt(addDays(today, 400)), 'ステータス': '稼働中', '備考': '', '登録日': '2022/01/10' },
  { '車両ID': 'V005', '車両名': 'マツダ デミオ', 'ナンバー': '杉並 200 お 7890', 'メーカー': 'マツダ', '車種': 'デミオ', '年式': '2018', '車検期限': fmt(addDays(today, 8)), '法定点検期限': fmt(subDays(today, 10)), 'ステータス': '稼働中', '備考': '廃車予定', '登録日': '2018/03/20' },
];
